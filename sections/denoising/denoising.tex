...
This section will use the formalism of \eqref{eq:noise-model} to present the Noise2Noise framework and its theoretical guarantees.
...
Another approach, coined \textbf{Recorrupted2Recorrupted} \cite{Pang2021} aims to provide a way to simulate noisy image pairs satisfying statistical conditions from single measurements.
